<?php get_header(); ?>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="<?php echo get_theme_file_uri('assets/img/logo/loder.png')?>" alt="">
                </div>
            </div>
        </div>
    </div> -->
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="<?php echo get_theme_file_uri('assets/img/logo/logo.png"')?> alt=""></a>
                            </div>
                        </div>
    ...
    <main>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <img src="<?php echo get_theme_file_uri('assets/img/gallery/signat')?>ure.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="best-pricing section-padding2 position-relative">
            ...
            <div class="pricing-img">
                <img class="pricing-img1" src="<?php echo get_theme_file_uri('assets/img/gallery/pricin')?>g1.png" alt="">
                <img class="pricing-img2" src="<?php echo get_theme_file_uri('assets/img/gallery/pricin')?>g2.png" alt="">
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo get_theme_file_uri('assets/img/gallery/home-b')?>log1.png" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo get_theme_file_uri('assets/img/gallery/home-b')?>log2.png" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="<?php echo get_theme_file_uri('assets/img/logo/logo2_foo')?>ter.png" alt=""></a>
                                </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="<?php  echo get_theme_file_uri('./assets/js/vendor/modernizr-3.5.0.min.js')?>"></script>
    <!-- Jquery, Popper, Bootstrap -->
    <script src="<?php  echo get_theme_file_uri('./assets/js/vendor/jquery-1.12.4.min.js')?>"></script>
    ...
    <script src="<?php  echo get_theme_file_uri('./assets/js/animated.headline.js')?>" ></script>
    <script src="<?php  echo get_theme_file_uri('./assets/js/jquery.magnific-popup.js')?>"></script>

    <!-- Date Picker -->
    <script src="<?php  echo get_theme_file_uri('./assets/js/gijgo.min.js')?>"></script>
    <!-- Nice-select, sticky -->
    <script src="<?php  echo get_theme_file_uri('./assets/js/jquery.nice-select.min.js')?>"></script>
    <script src="<?php  echo get_theme_file_uri('./assets/js/jquery.sticky.js')?>"></script>
    
    <!-- counter , waypoint,Hover Direction -->
    <script src="<?php  echo get_theme_file_uri('./assets/js/jquery.counterup.min.js')?>"></script>
    ...
    <script src="<?php  echo get_theme_file_uri('./assets/js/hover-direction-snake.min.js')?>"></script>

    <!-- contact js -->
    <script src="<?php  echo get_theme_file_uri('./assets/js/contact.js')?>"></script>
    <script src="<?php  echo get_theme_file_uri('./assets/js/jquery.form.js')?>"></script>
    <script src="<?php  echo get_theme_file_uri('./assets/js/jquery.validate.min.js')?>"></script>
    <script src="<?php  echo get_theme_file_uri('./assets/js/mail-script.js')?>"></script>
    <script src="<?php  echo get_theme_file_uri('./assets/js/jquery.ajaxchimp.min.js')?>"></script>
    
    <!-- Jquery Plugins, main Jquery -->	
    <script src="<?php  echo get_theme_file_uri('./assets/js/plugins.js')?>"></script>
