        ...
        <section class="about-area section-padding30 position-relative">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-11">
                        <!-- about-img -->
                        <div class="about-img ">
                            <img src="<?php echo get_theme_file_uri('assets/img/gallery/about.png')?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <img src="<?php echo get_theme_file_uri('assets/img/gallery/signature.png')?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="about-shape">
                <img src="<?php echo get_theme_file_uri('assets/img/gallery/about-shape.png')?>" alt="">
            </div>
        </section>
        <!-- About-2 Area End -->
        <!--? Services Area Start -->
                ...
                <div class="row team-active dot-style">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-80 text-center">
                            <div class="team-img">
                                <img src="<?php echo get_theme_file_uri('assets/img/gallery/team1.png')?>" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-80 text-center">
                            <div class="team-img">
                                <img src="<?php echo get_theme_file_uri('assets/img/gallery/team2.png')?>" alt="">
                            </div>
                            <div class="team-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-80 text-center">
                            <div class="team-img">
                                <img src="<?php echo get_theme_file_uri('assets/img/gallery/team3.png')?>" alt="">
                            </div>
                            <div class="team-caption">
                                <span>Master Barber</span>
        ...
        <div class="best-pricing section-padding2 position-relative">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="pricing-list">
                                    <ul>
                                        ...
                                        <li>Styling + Farbe. . . . . . . . . . . . . . . . . . . <span>€65</span></li>
                                        <li>Styling + Farbton. . . . . . . . . . . . . . . . . . . . . .<span>€65</span></li>
                                        <li>  Semi-permanent wave. . . . . . . . . . . . .<span>€65</span></li>
                                        <li> Schneiden + Styling. . . . . . . . . . . . . . . . . . . . . .<span>€63</span></li>
                                        <li> Schneiden + Styling + Farbe. . . . . . . . . . . . . <span>€100</span></li>
                                        <li> Schneiden + Styling + Tint. . . . . . . . . . . . . . . .<span>€100</span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="pricing-list">
                                    <ul>
                                        <li>Schneiden. . . . . . . . . . . . . . . . . . . . . . . . . . . . .<span>€25</span></li>
                                        <li>Rasur. . . . . . . . . . . . . . . . . . . . . . . . . . <span>€65</span></li>
                                        <li>Bart trim. . . . . . . . . . . . . . . . . . . . . .  <span>€65</span></li>
                                        <li>Schneiden + Bart trim. . . . . . . . . . . . . . . . .  <span>€65</span></li>
                                        <li>Schneiden + Rasur. . . . . . . . . . . . . . . . . . . . . . .<span>€63</span></li>
            ...
            <div class="pricing-img">
                <img class="pricing-img1" src="<?php echo get_theme_file_uri('assets/img/gallery/pricing1.png')?>" alt="">
                <img class="pricing-img2" src="<?php echo get_theme_file_uri('assets/img/gallery/pricing2.png')?>" alt="">
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(<?php echo get_theme_file_uri('assets/img/gallery/gallery1.png')?>);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(<?php echo get_theme_file_uri('assets/img/gallery/gallery2.png')?>);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(<?php echo get_theme_file_uri('assets/img/gallery/gallery3.png')?>);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(<?php echo get_theme_file_uri('assets/img/gallery/gallery4.png')?>);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Gallery Area End -->
        <!-- Cut Details Start -->
        <div class="cut-details section-bg section-padding2" data-background="<?php echo get_theme_file_uri('assets/img/gallery/section_bg02.png')?>">
           <div class="container">
            <div class="cut-active dot-style">
                <div class="single-cut">
                    ...
                    <div class="cut-descriptions">
                        <p>Herzlich willkommen beim Excelence Friseur und Barber in Bad Ischl! Professioneller Bart- und Haarschnitt zu günstigen Preisen. Für einen Wunschtermin rufen Sie uns an!</p>
                        <span>Mustafa Al Katrani</span>
                    </div>
                </div>
                <div class="single-cut">
                    <div class="cut-icon mb-20">
                    ...
                    <div class="cut-descriptions">
                        <p>
                        Herzlich willkommen beim Excelence Friseur und Barber in Bad Ischl! Professioneller Bart- und Haarschnitt zu günstigen Preisen. Für einen Wunschtermin rufen Sie uns an!
                        </p>
                        <span>Mustafa Al Katrani</span>
                    </div>
                </div>
                <div class="single-cut">
                    ...
                    <div class="cut-descriptions">
                        <p>
                        Das Casino, wenn es viel Zeit in Anspruch nehmen möchte, ist gemacht, meine Lacinia ist kostenlos. Der gesamte Verlauf des Kurses ist nicht der größte Lacher. Hängend                        </p>
                        <span>Mustafa Al Katrani</span>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-10 col-sm-10">
                        <div class="section-tittle text-center mb-90">
                            <span>Unsere neuesten Nachrichten</span>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo get_theme_file_uri('assets/img/gallery/home-blog1.png')?>" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo get_theme_file_uri('assets/img/gallery/home-blog2.png')?>" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
